...
use App\Http\Controllers\API\PatientsApi;
/*
|--------------------------------------------------------------------------
| Web Routes
|--------------------------------------------------------------------------
...
Route::post('/appointment/status_edit', 'AppointmentController@Status_edit')->name('appointment.Status_edit');
...
Route::put('/prescription/create{patient}', 'PrescriptionController@redirect')->name('prescription.redirect');
