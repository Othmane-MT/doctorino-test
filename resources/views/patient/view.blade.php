...
{{--                           
                          ...
                          {{-- End Modal --}}
                            ...
                            {{-- add Appointment form btn Toggle --}}
                              
                              <div class="p-2 d-flex justify-content-end" >
                                <form action="{{ route('appointments.redi',$patient->name) }}" method="post">
                                @csrf
                                @method('PUT')  
                        ...
                        <div class="tab-pane fade" id="prescriptions" role="tabpanel" aria-labelledby="prescriptions-tab">
                          <div class="p-2 d-flex justify-content-end" >
                            <form action="{{ route('prescription.redirect',$patient->name) }}" method="post">
                                @csrf
                                @method('PUT')
