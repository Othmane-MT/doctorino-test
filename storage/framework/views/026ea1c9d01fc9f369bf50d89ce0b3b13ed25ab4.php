                      ...
                      <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade" id="appointements" role="tabpanel" aria-labelledby="appointements-tab">
                              ...
                              <div class="p-2 d-flex justify-content-end" >
                                <form action="<?php echo e(route('appointments.redi',$patient->name)); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('PUT'); ?>  
                                <button type="submit" id="create-appointment" class="btn btn-outline-primary "  >
                        ...
                        <div class="tab-pane fade" id="prescriptions" role="tabpanel" aria-labelledby="prescriptions-tab">
                          <div class="p-2 d-flex justify-content-end" >
                            <form action="<?php echo e(route('prescription.redirect',$patient->name)); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('PUT'); ?>
                                <button type="submit" id="create-prescription" class="btn btn-outline-primary "  >
                                  <i class="fas fa-plus" ></i>
                                </button>
                              </form>
                              </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DELL\Desktop\doctorino\resources\views/patient/view.blade.php ENDPATH**/ ?>