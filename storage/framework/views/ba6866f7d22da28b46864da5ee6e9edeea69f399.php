            ...
            <div class="card-body">
               <div class="form-group">
                  ...
                  <select class="form-control select2 select2-hidden-accessible" id="drug" tabindex="-1" name="patient_id" aria-hidden="true">
                     ...
                     <?php if(($selected??'')&&$selected===$patient->name): ?> 
                         <option value="<?php echo e($patient->id); ?>" selected><?php echo e($patient->name); ?></option>
                     <?php else: ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DELL\Desktop\doctorino\resources\views/prescription/create.blade.php ENDPATH**/ ?>